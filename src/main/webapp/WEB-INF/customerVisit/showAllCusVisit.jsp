...
<table class="table table-striped">
    ...
    <c:forEach items="${list}" var="l">
        <tr>
            ...
            <td>
                <a class="btn btn-warning" data-toggle="modal" data-target="#myModal" onclick="readyModify(this)">修改</a>
                <a class="btn btn-danger" onclick="ManagerDelCus(this)">删除</a>
            </td>
        </tr>
    </c:forEach>
</table>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">修改客户访问信息</h4>
            </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" onclick="modifyCs()">保存修改</button>
            </div>
        </div>
    </div>
</div>
