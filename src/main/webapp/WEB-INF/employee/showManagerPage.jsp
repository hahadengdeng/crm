...
<script>
    ...
    var TableInit = function () {
        ...
        oTableInit.Init = function () {
            $("#tab1").bootstrapTable({
                url: "${pageContext.request.contextPath}/findAllManager.action",
                method: "get",
    ...
    function actionFormatter(val, row, index) {
        return "<a onclick='deleteManager(" + val + ")'><input type='button' value='删除' class='btn btn-danger'/></a>" +
            "<a data-toggle='modal' data-target='#myModal' onclick='readyUpdate(" + val + ")'><input type='button' value='修改' class='btn btn-warning'/></a>"
    }
